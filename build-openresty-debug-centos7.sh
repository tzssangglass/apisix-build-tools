...
yum -y install openresty-openssl111-debug-debuginfo openresty-openssl111-debug-debuginfo openresty-openssl111-debug-debuginfo
...
export OR_PREFIX=/usr/local/openresty-raw
